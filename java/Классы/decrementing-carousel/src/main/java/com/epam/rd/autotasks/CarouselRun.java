...
public class CarouselRun {
    ...
    public int next() {
        ...
        if (nextResult == 1) {
            //int nextElement = currentElement != carousel.getCurrentNumberOfElements() - 1 ? currentElement + 1 : 0;
            //nextNotZeroElement[currentElement] = nextNotZeroElement[nextElement];
